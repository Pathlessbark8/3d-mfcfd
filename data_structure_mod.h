...
struct points
{
    ...
    int xpos_conn[27][max_points], xneg_conn[27][max_points];
    int ypos_conn[27][max_points], yneg_conn[27][max_points];
    int zpos_conn[27][max_points], zneg_conn[27][max_points];
    //
