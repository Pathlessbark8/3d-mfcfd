module implicit_D_inv_outer_mod
...
!
!
!	This subroutine evaluates the D_inv of an outerboundary point during
!	the forward and backward sweeps ..


        subroutine implicit_D_inv_outer(i, D_inv)
!
!
		implicit none
...
!		
		...
		real*8 :: dist, weights
		real*8 :: temp, as
		real*8 :: dGxp, dGxn, dGyp, dGyn, dGzp
		real*8 :: D_inv, temp1
...
!
!
end module implicit_D_inv_outer_mod
