module implicit_D_inv_wall_mod
...
!
!
!	This subroutine evaluates the D_inv of a wall point during
!	the forward and backward sweeps ..


        subroutine implicit_D_inv_wall(i, D_inv)
!
!
		implicit none
...
!		
		...
		real*8 :: dist, weights
		real*8 :: temp, as
		real*8 :: dGxp, dGxn, dGyp, dGyn, dGzn
...
!
		...
		dGzn = -0.500*dabs(temp1 - dabs(temp1))*temp/det
!
!
		temp = (1.00/delta_t) - 2.00*(dGxp + dGxn + dGyp + dGyn + dGzn)
		D_inv = 1.00/temp
!		D_inv = delta_t
!			
        end subroutine
!
!
end module implicit_D_inv_wall_mod
