module implicit_LdelU_forward_sweep_interior_mod
...
!
!
!	This subroutine evaluates the LdelU of an interior point during the forward sweep ..


        subroutine implicit_LdelU_forward_sweep_interior(i, LdelU)
!
!
		implicit none
...
!
		dGzn = temp/det
!
		LdelU = dGxp + dGxn + dGyp + dGyn + dGzp + dGzn
!
!			
        end subroutine
!
!
end module implicit_LdelU_forward_sweep_interior_mod
