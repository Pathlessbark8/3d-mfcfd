module implicit_LdelU_forward_sweep_outer_mod

!	First written on 07.03.2021.
!	Revised on 09.04.2021.
!	Corrected on 16.04.2021.
!	
...
!
!
!	This subroutine evaluates the LdelU of an outer boundary point during the forward sweep ..


        subroutine implicit_LdelU_forward_sweep_outer(i, LdelU)
!
!
		implicit none
...
!
!
		LdelU = dGxp + dGxn + dGyp + dGyn + dGzp 
!
!			
        end subroutine
!
!
end module implicit_LdelU_forward_sweep_outer_mod
