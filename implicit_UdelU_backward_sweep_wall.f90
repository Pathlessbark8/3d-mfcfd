module implicit_UdelU_backward_sweep_wall_mod
...
!
!
!	This subroutine evaluates the UdelU of a wall point during the backward sweep ..


        subroutine implicit_UdelU_backward_sweep_wall(i, UdelU)
!
!
		implicit none
...
!
!
!	Compute dGzneg contributions to UdelU ..
!
		sum_delx_sqr = 0.0d0
		sum_dely_sqr = 0.0d0
		sum_delz_sqr = 0.0d0
...
!
		dGzn = temp/det
!
		UdelU = 2.0d0*(dGxp + dGxn + dGyp + dGyn + dGzn)
!
!			
        end subroutine
!
!
end module implicit_UdelU_backward_sweep_wall_mod
