...
!	This subroutine evaluates the outer flux derivative dGx_neg
...
!
			...
			call flux_Goxn(G_i, tan1, tan2, nor, prim)
!
			...
			call qtilde_to_primitive(qtilde, prim)
			call flux_Goxn(G_k, tan1, tan2, nor, prim)
!       
			temp = G_k - G_i
!
...
!
!
end module outer_flux_dGxneg_mod
