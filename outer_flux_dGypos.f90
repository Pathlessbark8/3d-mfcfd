...
!	This subroutine evaluates the outer flux derivative dGy_pos
...
!
			...
			call flux_Goyp(G_i, tan1, tan2, nor, prim)
!
			...
			call qtilde_to_primitive(qtilde, prim)
			call flux_Goyp(G_k, tan1, tan2, nor, prim)
!       
			temp = G_k - G_i
!
...
!
!
end module outer_flux_dGypos_mod
