...
__global__ void outer_dGy_pos_cuda(points &point,double power, double VL_CONST,double pi,int outer_points,int *outer_points_index)
//
//
{
...
__global__ void outer_dGy_pos_multi_nccl(splitPoints *splitPoint, double power, double VL_CONST, double pi, int outerPointsLocal, int *outerPointsLocalIndex,int* globalToLocalIndex,int **globalToGhostIndex,transferPoints **receiveBuffer,int *partVector)
//
//
{
	int ind = blockIdx.x * blockDim.x + threadIdx.x;
