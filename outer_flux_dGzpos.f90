...
!	This subroutine evaluates the outer flux derivative dGz_pos


        subroutine outer_dGz_pos(G, i)
!
!
		implicit none
...
!
			...
			call flux_Gzp(G_i, tan1, tan2, nor, prim)
!
			...
			call qtilde_to_primitive(qtilde, prim)
			call flux_Gzp(G_k, tan1, tan2, nor, prim)
!       
			temp = G_k - G_i
!
...
!
!
end module outer_flux_dGzpos_mod
