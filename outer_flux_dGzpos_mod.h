...
void outer_dGz_pos(double *G, int i)
//
//
{
...
__global__ void outer_dGz_pos_multi_nccl(splitPoints *splitPoint, double power, double VL_CONST, double pi, int outerPointsLocal, int *outerPointsLocalIndex,int* globalToLocalIndex,int **globalToGhostIndex,transferPoints **receiveBuffer,int *partVector)
//
//
{
	int ind = blockIdx.x * blockDim.x + threadIdx.x;
