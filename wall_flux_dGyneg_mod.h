...
__global__ void wall_dGy_neg_cuda(points &point,double power, double VL_CONST,double pi,int wall_points,int *wall_points_index)
//
//
{
...
//
//
__global__ void wall_dGy_neg_multi_nccl(int myRank,splitPoints *splitPoint, double power, double VL_CONST, double pi, int wallPointsLocal, int *wallPointsLocalIndex,int* globalToLocalIndex,int **globalToGhostIndex,transferPoints **receiveBuffer,int *partVector)
//
//
{
    int ind = blockIdx.x * blockDim.x + threadIdx.x;
