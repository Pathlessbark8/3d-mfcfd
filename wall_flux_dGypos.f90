...
!
			...
			call flux_Gwyp(G_i, tan1, tan2, nor, prim)
!
			...
			call qtilde_to_primitive(qtilde, prim)
			call flux_Gwyp(G_k, tan1, tan2, nor, prim)
!       
			temp = G_k - G_i
!
...
!
!
end module wall_flux_dGypos_mod
