...
//
//
__global__ void wall_dGy_pos_multi_nccl(splitPoints *splitPoint, double power, double VL_CONST, double pi, int wallPointsLocal, int *wallPointsLocalIndex,int* globalToLocalIndex,int **globalToGhostIndex,transferPoints **receiveBuffer,int *partVector)
//
//
{
    int ind = blockIdx.x * blockDim.x + threadIdx.x;
