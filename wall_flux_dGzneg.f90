...
!
			...
			call flux_Gzn(G_i, tan1, tan2, nor, prim)
!
			...
			call qtilde_to_primitive(qtilde, prim)
			call flux_Gzn(G_k, tan1, tan2, nor, prim)
!       
			temp = G_k - G_i
!
...
!
!
end module wall_flux_dGzneg_mod
